...
pub fn main() {
    ...
    //define slack vector
    let mut slack_poly = vec![Fr::zero(); mle_poly_size];
   ...
   //setup emd
   //define relaxed r1cs
    let relaxed_r1cs = |vars: &mut Vec<<P as ReturningValueProgramImpl>::ProgSymbol>|-> <P as ReturningValueProgramImpl>::ProgSymbol {
